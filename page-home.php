...
get_header(); ?>
      ...
      <div style="margin-top:5%; margin-bottom:5%;" class=<?php post_class('post post-single') ?>>
		 ...
		 <div style="margin-top:5%; margin-bottom:5%;" lass=<?php post_class('post post-single') ?>>
			<hr style="width:66%; padding:1.5%; margin:auto;">
			...
			<div  style="overflow:auto; text-align:center;">
				...
				<iframe style="display:inline-block;" width="560" height="315" src="https://www.youtube.com/embed/CYzd85A-oCE" frameborder="0" allowfullscreen></iframe>
			</div>
			<div style="margin:5%;">
